...
\lstinputlisting[style=customasm]{../assembly/encode.S}

\newpage

\subsubsection{Assembly decode.S}\label{decode.S}
\lstinputlisting[style=customasm]{../assembly/decode.S}

\newpage

\subsubsection{Assembly command.s}\label{command.s}
\lstinputlisting[style=customasm]{../assembly/command.s}
...
\subsubsection{Assembly file.s}\label{file.s}
\lstinputlisting[style=customasm]{../assembly/file.s}

\newpage

\subsubsection{Assembly main.s}\label{main.s}
\lstinputlisting[style=customasm]{../assembly/main.s}
